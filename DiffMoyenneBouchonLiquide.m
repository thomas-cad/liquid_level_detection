   ...
   while i < size(img)(1)
     while j < size(img)(2)
       ...
       if img(i,j) == bouchon
         ...
         %On avance dans la colonne jusqu'a la fin du bouchon
         while img(i,j) != 0
           j = j + 1;
         endwhile

         %On avance entre la fin du bouchon jusqu'au liquide
         while img(i,j)!= liquide
           n = n + 1; %On ajout '1' à la longueur entre le bouchon et le liquide
           j = j + 1;
         endwhile

         %On avance jusqu'a la fin du liquide
         while img(i,j)!= 0
           n = n + 1; %On ajout '1' à la longueur entre le bouchon et le liquide
           j = j + 1;
         endwhile
